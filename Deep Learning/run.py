...
x = torch.tensor([[5.0], [10.], [10.0], [5.0], [10.0],
                 [5.0], [10.], [10.0], [5.0], [10.0],
                 [5.0], [10.], [10.0], [5.0], [10.0],
                 [5.0], [10.], [10.0], [5.0], [10.0]], dtype=torch.float32)
...
with torch.no_grad():
    ...
    print(f'Predicted value for input: {predicted.item()} minutes')